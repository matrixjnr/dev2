...
import 'package:dev_to/pages/about_page.dart';
import 'package:dev_to/pages/news_page.dart';
...
class _HomePageState extends State<HomePage> {
  int page = 1;
  List<String> popupMenu = <String>["About", "Dark Mode"];
                  ...
                  onSelected: (selected) async {
                    if (selected == "About") {
                      ...
                      if (isDark(context)) {
                        ...
                        popupMenu[1] = "Dark Mode";
                      } else {
                        ThemeModeHandler.of(context)
                            .saveThemeMode(ThemeMode.dark);
                        popupMenu[1] = "Light Mode";
                      }
                    }
                  },
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                      ...
                      children: <Widget>[
                        ...
                        Text(
                            DateFormat.yMEd()
                                ...
                                .toString(),
                            style: TextStyle(color: Colors.grey, fontSize: 12, fontFamily: 'Nexa')),
                      ],
                    ),
                  ],
                ),
                Row(
                  children: <Widget>[
                    Icon(Icons.comment, size: 20, color: Color(0xffea5e3d)),
                    SizedBox(width: 4),
                    Text(
                      "${news.comments_count}",
                      style: TextStyle(color: Color(0xffea5e3d)),
                    ),
                    SizedBox(width: 4),
                    Icon(Icons.favorite_border,
                        size: 20, color: Color(0xffea5e3d)),
                    SizedBox(width: 4),
